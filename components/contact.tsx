      ...
      >
        ...
        <p className=" text-gray-700 dark:text-white/80 py-5 text-sm sm:text-base">
          ...
          <a
            ...
            href="https://mail.google.com/mail/?view=cm&fs=1&to=rahulhanje0.7@gmail.com"
            target="_blank"
...
const ContactItem = ({ icon, label }: { icon: JSX.Element; label: string }) => (
  <div className="flex items-center justify-center rounded-lg p-3 shadow-md transform hover:scale-105 transition duration-300 ease-in-out 
...
const LinkItem = ({
  ...
  <Link href={href} passHref legacyBehavior>
    <a
      target="_blank"
      rel="noopener noreferrer"
      className="flex items-center justify-center rounded-lg p-3 shadow-md transform hover:scale-105 transition duration-300 ease-in-out 
    bg-neutral-200 hover:bg-neutral-300 text-black 
    dark:bg-neutral-800 dark:hover:bg-neutral-700 dark:text-white"
    >
      {icon}
